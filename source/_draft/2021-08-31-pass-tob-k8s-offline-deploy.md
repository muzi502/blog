...
使用 docker 官方的安装脚本来安装 docker 是有一些小问题的：比如没有版本控制，不能指定版本，每次安装的 docker 版本都是最新的 stable 版本。没有版本控制就会导致不同时间部署的集群或者加入的节点，docker 版本可能就不一样，在这里可能会埋下一些坑，可能会带来一定的维护成本或者将来升级时遇到问题。
