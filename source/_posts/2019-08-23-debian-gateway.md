...
![1566567341680](https://blog.k8s.li/img/1566567341680.png)

### 2. kubeadm config image pull

使用 kubeadm 命令加上 `--kubernetes-version=` 参数指定镜像的版本号，速度还是可以的😂

![1566566813113](https://blog.k8s.li/img/1566566813113.png)

### 3. 使用 nload 命令查看网关流量情况

![pull gcr.k8s.io 上镜像的速度](https://blog.k8s.li/img/1566566775553.png)
...
![git clone 速度](https://blog.k8s.li/img/1566567116544.png)

### 5. 要代理的虚拟机

![1566565577328](https://blog.k8s.li/img/1566565577328.png)

### 5. 网关占用资源

![1566565631398](https://blog.k8s.li/img/1566565631398.png)
