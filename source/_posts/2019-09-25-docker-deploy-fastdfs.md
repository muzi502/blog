...
![1569728664464](https://blog.k8s.li/img/1569728664464.png)

#### alpine

基于 alpine 的基础镜像构建完成后，只有三层镜像😂

![1569728744655](https://blog.k8s.li/img/1569728744655.png)

#### debian

![1569729043301](https://blog.k8s.li/img/1569729043301.png)
...
![1564128425387](https://blog.k8s.li/img/1564128425387.png)

**测试文件数量和大小**

![1564128874832](https://blog.k8s.li/img/1564128874832.png)

**使用 xargs 执行 256 个进程并发上传 10w 张照片所用所用时间 为 2 分钟左右（内网）**

![1564128721547](https://blog.k8s.li/img/1564128721547.png)

**用时 2 分 11 秒**

![1564364594777](https://blog.k8s.li/img/1564364594777.png)

**客户端负载情况**

![1564127683217](https://blog.k8s.li/img/1564127683217.png)

**服务端负载情况**

![1564364294952](https://blog.k8s.li/img/1564364294952.png)

**服务端带宽流量**

![1564365025177](https://blog.k8s.li/img/1564365025177.png)

**服务端带宽流量**

![服务端带宽流量](https://blog.k8s.li/img/1564363829960.png)

**服务端上传结果**

![1564125161155](https://blog.k8s.li/img/1564125161155.png)

**服务端上传日志记录 ，均无错误输出**

![1564130238346](https://blog.k8s.li/img/1564130238346.png)
...
![1564130789416](https://blog.k8s.li/img/1564130789416.png)

**wget 下载**

使用 `wget -i` 参数指定 `url.log` 为标准输出来测试下载刚刚上传的 10W 张图片 用时 3 分 23 秒

![1564023927851](https://blog.k8s.li/img/1564023927851.png)
...
![1564384530137](https://blog.k8s.li/img/1564384530137.png)

2.tracker.conf 、storage.conf  默认配置文件监听的地址为 0.0.0.0 即本机所有的 IP 地址，建议修改为 FastDFS 服务器所在的内网 IP 地址。

![1564384711746](https://blog.k8s.li/img/1564384711746.png)

3.默认运行用户为当前用户和用户组为当前用户，建议指定为权限最小的用户来运行此进程。

![1564384906456](https://blog.k8s.li/img/1564384906456.png)
