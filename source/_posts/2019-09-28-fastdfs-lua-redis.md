...
![1564650409284](https://blog.k8s.li/img/1564650409284.png)
...
![1564706728602](https://blog.k8s.li/img/1564706728602.png)

**文件存储的一级子目录**

![1564706752461](https://blog.k8s.li/img/1564706752461.png)

**文件存储的二级子目录**

![1564706786739](https://blog.k8s.li/img/1564706786739.png)

**FastDFS 存储真实的文件，不对文件做分块、合并**

![1564706883566](https://blog.k8s.li/img/1564706883566.png)

**为方便测试，在这里打开了 `nginx` 列出目录选项**

![1564708725763](https://blog.k8s.li/img/1564708725763.png)

![1564708780114](https://blog.k8s.li/img/1564708780114.png)
...
![1564650287719](https://blog.k8s.li/img/1564650287719.png)

需要在原文件名前加上一个 ```/``` 作为 请求的 `uri`头 ,转换后的格式如下

![1564650709667](https://blog.k8s.li/img/1564650709667.png)
...
![1564712537149](https://blog.k8s.li/img/1564712537149.png)

**5.1.2 通过浏览器访问**

![1564712890280](https://blog.k8s.li/img/1564712890280.png)

**5.1.3 使用 wget 和 xargs 并行下载**

![1564650129311](https://blog.k8s.li/img/1564650129311.png)
...
![1564716508129](https://blog.k8s.li/img/1564716508129.png)