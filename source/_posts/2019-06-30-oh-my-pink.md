...
![1561802376515https://blog.k8s.li/img/1561802376515.png)
...
![1561802425505](https://blog.k8s.li/img/1561802425505.png)
...
![1561804056692](https://blog.k8s.li/img/1561804056692.png)

rsync 复制后的目录，却发现所有的所属信息都没了😂

![1561815022924](https://blog.k8s.li/img/1561815022924.png)
...
![1561822332154](https://blog.k8s.li/img/1561822332154.png)
...
![1561820231312](https://blog.k8s.li/img/1561820231312.png)

再次点击那个大大的 +  号，来添加单个任务。选择操作类别为代码

![1561820474017](https://blog.k8s.li/img/1561820474017.png)

选择代码操作为运行外壳

![1561820507625](https://blog.k8s.li/img/1561820507625.png)

添加 shell 运行命令，所有的操作都要使用 root 运行

![1561820547351](https://blog.k8s.li/img/1561820547351.png)

添加完成后，点击左下角那个开始按钮，如果任务左边为绿点，则运行成功。如果为红点，则会出现报错信息。

![1561820617830](https://blog.k8s.li/img/1561820617830.png)
...
![1562110188032](https://blog.k8s.li/img/1562110188032.png)

**点击 about 左侧那个按钮**

![1562110228770](https://blog.k8s.li/img/1562110228770.png)

**接着点击 Activity**

![1562110273463](https://blog.k8s.li/img/1562110273463.png)

**找到你使用的 Lancher，拉到最下面你会找到一个 WallpaperCropActivity。**

![1562110333067](https://blog.k8s.li/img/1562110333067.png)
